...
package org.opennars.language;//一个包
 ...
 */
//从29行开始看
public class Term implements AbstractTerm, Serializable {//Term类从AbstractTerm,Serializable继承
    public ImaginationSpace imagination;
    private static final Map<CharSequence,Term> atoms = new LinkedHashMap();//new构造方法
//看到这里
